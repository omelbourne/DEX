...
/**
 * getAntiparallelTokensBalance: Retrieves the tokens in the account
 * of the provided `adddress`
 */
export const getAntiparallelTokensBalance = async (provider, address) => {
  try {
    ...
    const balanceOfAntiparallelTokens = await tokenContract.balanceOf(address);
    return balanceOfAntiparallelTokens;
  } catch (err) {
    console.error(err);
  }
};
